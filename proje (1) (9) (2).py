...
while ask_continue == "Y" or ask_continue == "y":
    ...
    previous_day_value = int(input("previous_day_value:"))
    current_day_value = int(input("current_day_value:"))
    previous_peak_value = int(input("previous_peak_value:"))
    current_peak_value = int(input("current_peak_value:"))
    previous_night_value = int(input("previous_night_value:"))
    current_night_value = int(input("current_night_value:"))
    days_between_reading = int(input("days_between_reading:"))
    consumption_yearly = int(input("consumption_yearly:"))
    ...
    print(f"consumer_no:{consumer_no}, consumer_type_code:{consumer_type_code}, \
          day_consumption:{day_consumption}, peak_consumption:{peak_consumption},\
          night_consumption:{night_consumption},\
          total_consumption:{total_consumption}, consumption_fee:{consumption_fee}, transferred_to_the_municipality:{transferred_to_the_municipality}, transferred_to_the_state:{transferred_to_the_state},\
           bill:{bill},consumption_yearly:{consumption_yearly},free_consumer:{free_consumer}")
    ...
    ask_continue = input("ask_continue Y,y,N,n")
...
if industrial_consumer_count != 0:
    ...
    print(f"industrial_consumer_count:{industrial_consumer_count}, industrial_consumer_perc:{industrial_consumer_perc}, avg_industrial_consumption:{avg_industrial_consumption}, industrial_usage_total:{industrial_usage_total}")
    print(f"exceeding_industry_consumer_count:{exceeding_industry_consumer_count}, perc_exceeding_industrial_consumer:{perc_exceeding_industrial_consumer},exceeding_industry_consumer_bill_count:{exceeding_industry_consumer_bill_count},perc_exceeding_industrial_consumer_bill:{perc_exceeding_industrial_consumer_bill}")
...
if public_and_private_consumer_count != 0:
    ...
    print(f"public_and_private_consumer_count:{public_and_private_consumer_count}, public_and_private_consumer_perc:{public_and_private_consumer_perc}, avg_public_and_private_consumption:{avg_public_and_private_consumption}, public_and_private_usage_total:{public_and_private_usage_total}")
...
if agricultural_consumer_count != 0:
    ...
    print(f"agricultural_consumer_count:{agricultural_consumer_count}, agricultural_consumer_perc:{agricultural_consumer_perc}, avg_agricultural_consumption:{avg_agricultural_consumption}, agricultural_usage_total:{agricultural_usage_total}")
if residential_consumer_count != 0:
    ...
    print(f"residential_consumer_count:{residential_consumer_count}, residential_consumer_perc{residential_consumer_perc}, avg_residential_consumption{avg_residential_consumption}, residential_usage_total:{residential_usage_total}")
    print(f"highest_residential_consumer_no:{highest_residential_consumer_no}, highest_residential_consumer_daily:{highest_residential_consumer_daily},bill:{bill}")
...
if lighting_consumer_count != 0:
    ...
    print(f"lighting_consumer_count:{lighting_consumer_count}, lighting_consumer_perc:{lighting_consumer_perc}, avg_lighting_consumption:{avg_lighting_consumption}, lighting_usage_total:{lighting_usage_total}")
...
print(f"total_transferred_to_the_GDZ_corporation:{total_transferred_to_the_GDZ_corporation},total_transferred_to_the_municipality:{total_transferred_to_the_municipality},total_transferred_to_the_state:{total_transferred_to_the_state}")
